"""
Django settings for cold_bonus_dev_75470 project.
...
ROOT_URLCONF = 'cold_bonus_dev_75470.urls'
...
WSGI_APPLICATION = 'cold_bonus_dev_75470.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_bonus_dev_75470 API",
    "DESCRIPTION": "API documentation for cold_bonus_dev_75470 App",
    "VERSION": "v1",
}
